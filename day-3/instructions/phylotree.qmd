...
Input data are available at the directory `day-3/phylogenetics/input`. These include the pseudogenome sequences in `.fasta` format for the genomes which previously completed the mapping step. A short metadata in `.csv` format is also included for visualisation purpose.
